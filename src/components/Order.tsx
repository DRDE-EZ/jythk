  ...
  return (
    <div className="w-full space-y-5 border p-5">
      ...
      <div className="flex flex-wrap justify-between gap-3 text-sm">
        <div className="basis-96">
          <div className="space-y-0.5">
            <div className="flex items-center gap-3 font-semibold">
              ...
              <div
                className={cn(
                  "bg-secondary border-1 p-2 text-bold text-secondary-foreground",
        ...
        {shippingDestination && (
          <div className="space-y-0.5 pe-10 sm:pt-3">
...
function OrderItem({ item }: OrderItemProps) {
  return (
    <div className="flex gap-3 py-5 last: pb-0">
      <WixImage
        mediaIdentifier={item.image}
        width={110}
        height={110}
        alt={item.productName?.translated || "Product image"}
        className="flex-none bg-none"
      />
      <div className="space-y-0.5 flex-1 my-auto">
